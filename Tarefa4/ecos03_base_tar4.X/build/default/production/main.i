...
# 53 "C:/Program Files/Microchip/MPLABX/v6.05/packs/Microchip/PIC18Fxxxx_DFP/1.3.36/xc8\pic\include\proc\pic18f4520.h"
...
char updateLCD(void)
{
lcd->funcoes[LCD_CMD](0x01);

lcd->funcoes[LCD_DATA]((char)hora/10 + '0');
lcd->funcoes[LCD_CMD](0x06);
lcd->funcoes[LCD_DATA]((char)hora%10 + '0');
lcd->funcoes[LCD_CMD](0x06);
...
void main(void) {
process p1 = {counter, 10, 0};
process p2 = {updateLCD, 10, 0};
TRISD = 0x00;
timerInit();
