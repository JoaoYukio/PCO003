...
FINAL_IMAGE=${DISTDIR}/ecos03_base_tar4.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=main.c kernel.c drv_led.c adc.c ds1307.c io.c keypad.c lcd.c pwm.c serial.c soft_i2c.c ssd.c timer.c drv_lcd2.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/main.p1 ${OBJECTDIR}/kernel.p1 ${OBJECTDIR}/drv_led.p1 ${OBJECTDIR}/adc.p1 ${OBJECTDIR}/ds1307.p1 ${OBJECTDIR}/io.p1 ${OBJECTDIR}/keypad.p1 ${OBJECTDIR}/lcd.p1 ${OBJECTDIR}/pwm.p1 ${OBJECTDIR}/serial.p1 ${OBJECTDIR}/soft_i2c.p1 ${OBJECTDIR}/ssd.p1 ${OBJECTDIR}/timer.p1 ${OBJECTDIR}/drv_lcd2.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/main.p1.d ${OBJECTDIR}/kernel.p1.d ${OBJECTDIR}/drv_led.p1.d ${OBJECTDIR}/adc.p1.d ${OBJECTDIR}/ds1307.p1.d ${OBJECTDIR}/io.p1.d ${OBJECTDIR}/keypad.p1.d ${OBJECTDIR}/lcd.p1.d ${OBJECTDIR}/pwm.p1.d ${OBJECTDIR}/serial.p1.d ${OBJECTDIR}/soft_i2c.p1.d ${OBJECTDIR}/ssd.p1.d ${OBJECTDIR}/timer.p1.d ${OBJECTDIR}/drv_lcd2.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/main.p1 ${OBJECTDIR}/kernel.p1 ${OBJECTDIR}/drv_led.p1 ${OBJECTDIR}/adc.p1 ${OBJECTDIR}/ds1307.p1 ${OBJECTDIR}/io.p1 ${OBJECTDIR}/keypad.p1 ${OBJECTDIR}/lcd.p1 ${OBJECTDIR}/pwm.p1 ${OBJECTDIR}/serial.p1 ${OBJECTDIR}/soft_i2c.p1 ${OBJECTDIR}/ssd.p1 ${OBJECTDIR}/timer.p1 ${OBJECTDIR}/drv_lcd2.p1

# Source Files
SOURCEFILES=main.c kernel.c drv_led.c adc.c ds1307.c io.c keypad.c lcd.c pwm.c serial.c soft_i2c.c ssd.c timer.c drv_lcd2.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/ecos03_base_tar4.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/drv_lcd2.p1: drv_lcd2.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/drv_lcd2.p1.d 
	@${RM} ${OBJECTDIR}/drv_lcd2.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=none   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -v -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c90 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/drv_lcd2.p1 drv_lcd2.c 
	@-${MV} ${OBJECTDIR}/drv_lcd2.d ${OBJECTDIR}/drv_lcd2.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/drv_lcd2.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/ecos03_base_tar4.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/ecos03_base_tar4.X.${IMAGE_TYPE}.map  -D__DEBUG=1  -mdebugger=none  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -v -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c90 -gdwarf-3 -mstack=compiled:auto:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/ecos03_base_tar4.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} ${DISTDIR}/ecos03_base_tar4.X.${IMAGE_TYPE}.hex 
	
else
${DISTDIR}/ecos03_base_tar4.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/ecos03_base_tar4.X.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -v -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c90 -gdwarf-3 -mstack=compiled:auto:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/ecos03_base_tar4.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
